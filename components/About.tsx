  ...
  return (
    <section id="about" className="py-24 md:py-32 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 items-start">
        ...
        >
           <div className="w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-br from-[#22007c] to-[#0d00a4] p-1.5 shadow-lg shadow-blue-900/20">
            <img
              src={profileImage}
        ...
        >
          <h2 className="text-3xl font-bold text-[#e2e8f0] mb-6">About Me</h2>
          ...
          <div className="space-y-8">
              ...
              >
                <h3 className="flex items-center gap-3 text-2xl font-bold text-[#e2e8f0] mb-4">
                  <GraduationCapIcon className="w-7 h-7 text-blue-400" />
                  Education
                </h3>
                <div className="bg-[#04052e]/50 p-6 rounded-lg border border-[#140152]">
                  <h4 className="font-semibold text-blue-300">B.Sc. in Information Technology</h4>
                  <p className="text-slate-400">Mettu University - Graduated 2023</p>
              ...
              >
                <h3 className="flex items-center gap-3 text-2xl font-bold text-[#e2e8f0] mb-4">
                  <LanguagesIcon className="w-7 h-7 text-blue-400" />
                  Languages
                </h3>
                <div className="bg-[#04052e]/50 p-6 rounded-lg border border-[#140152]">
                  <ul className="list-disc list-inside text-slate-400 space-y-2">
